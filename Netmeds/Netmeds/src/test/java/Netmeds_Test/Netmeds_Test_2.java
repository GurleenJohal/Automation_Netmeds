...
public class Netmeds_Test_2 extends Netmeds_Testbase{
  ...
  public void Lab_Tests() throws InterruptedException {
	  ...
	  test=extent.startTest("Verify whether Netmeds health-packages Page Loads Successfully");
	  test.log(LogStatus.INFO, "Netmeds health-packages Page Test is intiated");
	  test.log(LogStatus.INFO,"Verify Netmeds health-packages Page Loads Successfully");
	
	  Thread.sleep(2000);
	  netmeds_page2.Lab_Tests().click();
	  System.out.println("---Netmeds health-packages Page is invoked----\n");
  ...
  public void Beauty_Fragrances() throws InterruptedException {
	  ...
	  test.log(LogStatus.INFO,"Verify Netmeds Beauty Page Loads Successfully");
  ...
  public void Beauty_Tools() throws InterruptedException {
	  test=extent.startTest("Verify whether Tools page of beauty module is invoked Successfully");
	  test.log(LogStatus.INFO, "Netmeds Beauty Page Test is intiated");
	  test.log(LogStatus.INFO,"Verify Netmeds Beauty Page Loads Successfully");
	  ...
	  if(actual.equals(expected)) {
			test.log(LogStatus.PASS, "Tools page of beauty module is invoked Successfully");
		}
		else {
			test.log(LogStatus.FAIL, "Tools page of beauty module is not invoked Successfully");
		}
  ...
  public void Health_Corner_HealthLibrary() throws InterruptedException {
	  ...
	  test.log(LogStatus.INFO, "Netmeds Health Library Page Test is intiated");
	  ...
	  if(actual.equals(expected)) {
			test.log(LogStatus.PASS, "Health library page of beauty module is invoked Successfully");
		}
		else {
			test.log(LogStatus.FAIL, "Health library page of beauty module is not invoked Successfully");
		}
